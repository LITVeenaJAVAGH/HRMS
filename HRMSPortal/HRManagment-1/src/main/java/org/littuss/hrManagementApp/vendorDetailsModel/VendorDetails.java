...
public class VendorDetails {
	...
	public VendorDetails(Long id, String vendorName, String rateCard, String location, String jobType, String payRoll,
			...
			String secondReviewed, String cvFormate) {
		super();
		this.id = id;
	...
	public void setCvFormate(String cvFormate) {
		this.cvFormate = cvFormate;
	}
